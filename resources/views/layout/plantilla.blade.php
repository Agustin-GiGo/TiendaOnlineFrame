	...
	<div class="wrapper">
		<nav class="navbar navbar-expand-lg shadow">
			<div class="collapse navbar-collapse">
					 ...
					 <a href="{{ url('/')}}"><h4>Categoria</h4></a>
     				 <a href="{{ url('/listaproducto')}}"><h4>Productos</h4></a>
     				 <a href="{{ url('/AcercaDe') }}"><h4>Vision y mision </h4></a>
     				 <a href="{{ url('/contacto') }}"><h4>Contacto</h4></a>
     			 </ul></center>

     			 	<u1 class="nav navbar-nav navbar-right">
            <a href="{{ url('/register') }}"><button class="btn-primary btn-lg active">Registrarse</button></a>
            </u1>

				<u1 class="nav navbar-nav navbar-right">
            <a href="{{ url('/autenticar') }}"><button class="btn-success btn-lg active">Iniciar Sesion</button></a>
            </u1>
        </ul>
